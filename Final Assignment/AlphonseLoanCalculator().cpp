...
int main()
{
    ...
    string alphonseLoanCalculator;
    
    string alphonseLoanCalculator= (age > 22, bankBalance > 50000, CRB = "Good", accountAge > 6)? "Eligible For Loan" : "Ineligible For Loan";
    cout <<alphonseLoanCalculator <<endl;  
    }